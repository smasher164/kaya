...
appearanceSystem :: Word32
appearanceSystem = 0
appearanceLight :: Word32
appearanceLight = 1
appearanceDark :: Word32
appearanceDark = 2
...
txSetFill :: Word64 -> Bool -> Builder
txSetFill widgetId fill = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFill <> word32LE sourceConst
    <> encodeValue (VBool fill))

-- set_property with a signal-bound fill value.
txBindFill :: Word64 -> Word64 -> Builder
txBindFill widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFill <> word32LE sourceSignal
    <> word64LE signalId)

-- set_property bound to one field of the element of the enclosing
-- For, `level` Fors up (0 = nearest; field 0 for a scalar).
txBindFillElement :: Word64 -> Word32 -> Word32 -> Builder
txBindFillElement widgetId level field = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFill <> word32LE sourceElement
    <> word32LE level <> word32LE field)

-- set_property with a constant min_column_width value.
txSetMinColumnWidth :: Word64 -> Double -> Builder
txSetMinColumnWidth widgetId minColumnWidth = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propMinColumnWidth <> word32LE sourceConst
    <> encodeValue (VF64 minColumnWidth))

-- set_property with a signal-bound min_column_width value.
txBindMinColumnWidth :: Word64 -> Word64 -> Builder
txBindMinColumnWidth widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propMinColumnWidth <> word32LE sourceSignal
    <> word64LE signalId)
...
txSetPlaceholder :: Word64 -> String -> Builder
txSetPlaceholder widgetId placeholder = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propPlaceholder <> word32LE sourceConst
    <> encodeValue (VStr placeholder))

-- set_property with a signal-bound placeholder value.
txBindPlaceholder :: Word64 -> Word64 -> Builder
txBindPlaceholder widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propPlaceholder <> word32LE sourceSignal
    <> word64LE signalId)

-- set_property bound to one field of the element of the enclosing
-- For, `level` Fors up (0 = nearest; field 0 for a scalar).
txBindPlaceholderElement :: Word64 -> Word32 -> Word32 -> Builder
txBindPlaceholderElement widgetId level field = wireRecord txKindSetProperty
...
txSetSubmits :: Word64 -> Bool -> Builder
txSetSubmits widgetId submits = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propSubmits <> word32LE sourceConst
    <> encodeValue (VBool submits))

-- set_property with a signal-bound submits value.
txBindSubmits :: Word64 -> Word64 -> Builder
txBindSubmits widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propSubmits <> word32LE sourceSignal
    <> word64LE signalId)
...
txSetFollowsEnd :: Word64 -> Bool -> Builder
txSetFollowsEnd widgetId followsEnd = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFollowsEnd <> word32LE sourceConst
    <> encodeValue (VBool followsEnd))

-- set_property with a signal-bound follows_end value.
txBindFollowsEnd :: Word64 -> Word64 -> Builder
txBindFollowsEnd widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFollowsEnd <> word32LE sourceSignal
    <> word64LE signalId)

-- set_property bound to one field of the element of the enclosing
-- For, `level` Fors up (0 = nearest; field 0 for a scalar).
txBindFollowsEndElement :: Word64 -> Word32 -> Word32 -> Builder
txBindFollowsEndElement widgetId level field = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propFollowsEnd <> word32LE sourceElement
    <> word32LE level <> word32LE field)

-- set_property with a constant max_lines value.
txSetMaxLines :: Word64 -> Double -> Builder
txSetMaxLines widgetId maxLines = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propMaxLines <> word32LE sourceConst
    <> encodeValue (VF64 maxLines))

-- set_property with a signal-bound max_lines value.
txBindMaxLines :: Word64 -> Word64 -> Builder
txBindMaxLines widgetId signalId = wireRecord txKindSetProperty
  (word64LE widgetId <> word32LE propMaxLines <> word32LE sourceSignal
    <> word64LE signalId)
...
txSetWindowAppearance :: Word64 -> Int64 -> Builder
txSetWindowAppearance window appearance = wireRecord txKindSetWindowProp
  (word64LE window <> word32LE wpropAppearance <> word32LE sourceConst
    <> encodeValue (VI64 appearance))
