...
static class KayaWire
{
    ...
    public static byte[] TxSetStep(ulong widgetId, double step)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropStep); w.Write(SourceConst);
        EncodeValue(w, step);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound step value.
    public static byte[] TxBindStep(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropStep); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindStepElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropStep); w.Write(SourceElement); w.Write(level); w.Write(field);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a constant tick_spacing value.
    public static byte[] TxSetTickSpacing(ulong widgetId, double tickSpacing)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropTickSpacing); w.Write(SourceConst);
        EncodeValue(w, tickSpacing);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound tick_spacing value.
    public static byte[] TxBindTickSpacing(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropTickSpacing); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindTickSpacingElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropTickSpacing); w.Write(SourceElement); w.Write(level); w.Write(field);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a constant help value.
    public static byte[] TxSetHelp(ulong widgetId, string help)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropHelp); w.Write(SourceConst);
        EncodeValue(w, help);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound help value.
    public static byte[] TxBindHelp(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropHelp); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindHelpElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
    ...
    public static byte[] TxSetMinColumnWidth(ulong widgetId, double minColumnWidth)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropMinColumnWidth); w.Write(SourceConst);
        EncodeValue(w, minColumnWidth);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound min_column_width value.
    public static byte[] TxBindMinColumnWidth(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropMinColumnWidth); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindMinColumnWidthElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropMinColumnWidth); w.Write(SourceElement); w.Write(level); w.Write(field);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a constant wrap value.
    public static byte[] TxSetWrap(ulong widgetId, bool wrap)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropWrap); w.Write(SourceConst);
        EncodeValue(w, wrap);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound wrap value.
    public static byte[] TxBindWrap(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropWrap); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindWrapElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
    ...
    public static byte[] TxSetDocument(ulong widgetId, ulong handle)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropDocument); w.Write(SourceConst);
        EncodeValue(w, new BlobHandle(handle));
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound document value.
    public static byte[] TxBindDocument(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropDocument); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindDocumentElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropDocument); w.Write(SourceElement); w.Write(level); w.Write(field);
        return Finish(stream, w, TxKindSetProperty);
    }
    ...
    public static byte[] TxSetFollowsEnd(ulong widgetId, bool followsEnd)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropFollowsEnd); w.Write(SourceConst);
        EncodeValue(w, followsEnd);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property with a signal-bound follows_end value.
    public static byte[] TxBindFollowsEnd(ulong widgetId, ulong signalId)
    {
        var w = Begin(out var stream);
        w.Write(widgetId); w.Write(PropFollowsEnd); w.Write(SourceSignal); w.Write(signalId);
        return Finish(stream, w, TxKindSetProperty);
    }

    /// set_property bound to one field of the element of the enclosing For.
    public static byte[] TxBindFollowsEndElement(ulong widgetId, uint level = 0, uint field = 0)
    {
        var w = Begin(out var stream);
