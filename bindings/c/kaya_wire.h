...
#define KAYA_SPEC_HASH 0xcad44d3c6e3d9800ULL
...
static inline void kaya_tx_create_breakpoint(KayaTx *tx, uint64_t window, KayaVal size_class, uint32_t count, const KayaVal *setters, uint32_t setters_len) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_CREATE_BREAKPOINT);
    kaya_wire_u64(tx, window);
    kaya_wire_value(tx, size_class);
    kaya_wire_u32(tx, count);
    kaya_wire_u32(tx, 0);
...
static inline void kaya_tx_set_help(KayaTx *tx, uint64_t widget_id, const char *help) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HELP);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_str(help));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound help value. */
static inline void kaya_tx_bind_help(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HELP);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_help_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HELP);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_fill(KayaTx *tx, uint64_t widget_id, int fill) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FILL);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_bool(fill));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound fill value. */
static inline void kaya_tx_bind_fill(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FILL);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_fill_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FILL);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_min_column_width(KayaTx *tx, uint64_t widget_id, double min_column_width) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MIN_COLUMN_WIDTH);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_f64(min_column_width));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound min_column_width value. */
static inline void kaya_tx_bind_min_column_width(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MIN_COLUMN_WIDTH);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_min_column_width_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MIN_COLUMN_WIDTH);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_wrap(KayaTx *tx, uint64_t widget_id, int wrap) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_WRAP);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_bool(wrap));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound wrap value. */
static inline void kaya_tx_bind_wrap(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_WRAP);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_wrap_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_WRAP);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_placeholder(KayaTx *tx, uint64_t widget_id, const char *placeholder) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_PLACEHOLDER);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_str(placeholder));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound placeholder value. */
static inline void kaya_tx_bind_placeholder(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_PLACEHOLDER);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_placeholder_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_PLACEHOLDER);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_href(KayaTx *tx, uint64_t widget_id, const char *href) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HREF);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_str(href));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound href value. */
static inline void kaya_tx_bind_href(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HREF);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_href_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_HREF);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_document(KayaTx *tx, uint64_t widget_id, uint64_t handle) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_DOCUMENT);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_blob(handle));
    kaya_wire_end(tx, kaya_at);
}
...
static inline void kaya_tx_bind_document(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_DOCUMENT);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_document_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_DOCUMENT);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_submits(KayaTx *tx, uint64_t widget_id, int submits) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SUBMITS);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_bool(submits));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound submits value. */
static inline void kaya_tx_bind_submits(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SUBMITS);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_submits_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SUBMITS);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_follows_end(KayaTx *tx, uint64_t widget_id, int follows_end) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FOLLOWS_END);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_bool(follows_end));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound follows_end value. */
static inline void kaya_tx_bind_follows_end(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FOLLOWS_END);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_follows_end_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_FOLLOWS_END);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_max_lines(KayaTx *tx, uint64_t widget_id, double max_lines) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MAX_LINES);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
    kaya_wire_value(tx, kaya_f64(max_lines));
    kaya_wire_end(tx, kaya_at);
}

/* set_property with a signal-bound max_lines value. */
static inline void kaya_tx_bind_max_lines(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MAX_LINES);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_max_lines_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_MAX_LINES);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
static inline void kaya_tx_set_symbol(KayaTx *tx, uint64_t widget_id, int64_t symbol) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SYMBOL);
    kaya_wire_u32(tx, KAYA_SOURCE_CONST);
...
static inline void kaya_tx_bind_symbol(KayaTx *tx, uint64_t widget_id, uint64_t signal_id) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SYMBOL);
    kaya_wire_u32(tx, KAYA_SOURCE_SIGNAL);
...
/* set_property bound to one field of the element of the enclosing
 * For, `level` Fors up (field 0 for a scalar collection). */
static inline void kaya_tx_bind_symbol_element(KayaTx *tx, uint64_t widget_id, uint32_t level, uint32_t field) {
    size_t kaya_at = kaya_wire_begin(tx, KAYA_TX_SET_PROPERTY);
    kaya_wire_u64(tx, widget_id);
    kaya_wire_u32(tx, KAYA_PROP_SYMBOL);
    kaya_wire_u32(tx, KAYA_SOURCE_ELEMENT);
...
/* Decode a submitted occurrence: same identity head as a click, then
 * its payload as one Str value (strings point into rec). Returns 1
 * and fills the outputs, or 0 for other kinds. */
static inline int kaya_parse_submitted(const uint8_t *rec, uint64_t *id,
                                        KayaVal *keys, uint32_t max_keys,
                                        uint32_t *n_keys, KayaVal *payload) {
    const KayaRecordButtonClicked *r = (const KayaRecordButtonClicked *)rec;
