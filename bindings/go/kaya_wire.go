...
// TxSetWrap: set_property with a constant wrap value.
func TxSetWrap(widgetID uint64, wrap bool) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropWrap)
	b = binary.LittleEndian.AppendUint32(b, SourceConst)
	b = encodeValue(b, wrap)
	return endRecord(b)
}

// TxBindWrap: set_property with a signal-bound wrap value.
func TxBindWrap(widgetID uint64, signalID uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropWrap)
	b = binary.LittleEndian.AppendUint32(b, SourceSignal)
...
// TxBindWrapElement: set_property bound to one field of the element of the
// enclosing For, `level` Fors up (0 = nearest).
func TxBindWrapElement(widgetID uint64, level uint32, field uint32) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropWrap)
	b = binary.LittleEndian.AppendUint32(b, SourceElement)
...
// TxSetPlaceholder: set_property with a constant placeholder value.
func TxSetPlaceholder(widgetID uint64, placeholder string) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropPlaceholder)
	b = binary.LittleEndian.AppendUint32(b, SourceConst)
	b = encodeValue(b, placeholder)
	return endRecord(b)
}

// TxBindPlaceholder: set_property with a signal-bound placeholder value.
func TxBindPlaceholder(widgetID uint64, signalID uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropPlaceholder)
	b = binary.LittleEndian.AppendUint32(b, SourceSignal)
...
// TxBindPlaceholderElement: set_property bound to one field of the element of the
// enclosing For, `level` Fors up (0 = nearest).
func TxBindPlaceholderElement(widgetID uint64, level uint32, field uint32) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropPlaceholder)
	b = binary.LittleEndian.AppendUint32(b, SourceElement)
...
// TxSetDocument: set_property with a constant document value.
func TxSetDocument(widgetID uint64, handle uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropDocument)
	b = binary.LittleEndian.AppendUint32(b, SourceConst)
	b = encodeValue(b, BlobHandle(handle))
	return endRecord(b)
}

// TxBindDocument: set_property with a signal-bound document value.
func TxBindDocument(widgetID uint64, signalID uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropDocument)
	b = binary.LittleEndian.AppendUint32(b, SourceSignal)
...
// TxBindDocumentElement: set_property bound to one field of the element of the
// enclosing For, `level` Fors up (0 = nearest).
func TxBindDocumentElement(widgetID uint64, level uint32, field uint32) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropDocument)
	b = binary.LittleEndian.AppendUint32(b, SourceElement)
...
// TxSetFilled: set_property with a constant filled value.
func TxSetFilled(widgetID uint64, filled int64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropFilled)
	b = binary.LittleEndian.AppendUint32(b, SourceConst)
	b = encodeValue(b, filled)
	return endRecord(b)
}

// TxBindFilled: set_property with a signal-bound filled value.
func TxBindFilled(widgetID uint64, signalID uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropFilled)
	b = binary.LittleEndian.AppendUint32(b, SourceSignal)
...
// TxBindFilledElement: set_property bound to one field of the element of the
// enclosing For, `level` Fors up (0 = nearest).
func TxBindFilledElement(widgetID uint64, level uint32, field uint32) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropFilled)
	b = binary.LittleEndian.AppendUint32(b, SourceElement)
...
// TxSetMaxLines: set_property with a constant max_lines value.
func TxSetMaxLines(widgetID uint64, maxLines float64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropMaxLines)
	b = binary.LittleEndian.AppendUint32(b, SourceConst)
	b = encodeValue(b, maxLines)
	return endRecord(b)
}

// TxBindMaxLines: set_property with a signal-bound max_lines value.
func TxBindMaxLines(widgetID uint64, signalID uint64) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropMaxLines)
	b = binary.LittleEndian.AppendUint32(b, SourceSignal)
...
// TxBindMaxLinesElement: set_property bound to one field of the element of the
// enclosing For, `level` Fors up (0 = nearest).
func TxBindMaxLinesElement(widgetID uint64, level uint32, field uint32) []byte {
	b := beginRecord(txSetProperty)
	b = binary.LittleEndian.AppendUint64(b, widgetID)
	b = binary.LittleEndian.AppendUint32(b, PropMaxLines)
	b = binary.LittleEndian.AppendUint32(b, SourceElement)
...
// Panics on whitespace, empty tokens, repeated modifiers, aliases
...
// bytes. Kind is a SINGLE member of the clip enum and never a mask
