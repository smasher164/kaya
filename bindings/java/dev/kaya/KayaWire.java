...
public final class KayaWire {
    ...
    public static byte[] txSetMinColumnWidth(long widgetId, double minColumnWidth) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_MIN_COLUMN_WIDTH).putInt(SOURCE_CONST);
        encodeValue(b, minColumnWidth);
        return finish(b);
    }

    /** set_property with a signal-bound min_column_width value. */
    public static byte[] txBindMinColumnWidth(long widgetId, long signalId) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_MIN_COLUMN_WIDTH).putInt(SOURCE_SIGNAL).putLong(signalId);
        return finish(b);
    }
    ...
    public static byte[] txSetDocument(long widgetId, long handle) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_DOCUMENT).putInt(SOURCE_CONST);
        encodeValue(b, new BlobHandle(handle));
        return finish(b);
    }

    /** set_property with a signal-bound document value. */
    public static byte[] txBindDocument(long widgetId, long signalId) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_DOCUMENT).putInt(SOURCE_SIGNAL).putLong(signalId);
        return finish(b);
    }

    /** set_property bound to one field of the element of the enclosing For. */
    public static byte[] txBindDocumentElement(long widgetId, int level, int field) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_DOCUMENT).putInt(SOURCE_ELEMENT)
                .putInt(level).putInt(field);
        return finish(b);
    }
    ...
    public static byte[] txSetMaxLines(long widgetId, double maxLines) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_MAX_LINES).putInt(SOURCE_CONST);
        encodeValue(b, maxLines);
        return finish(b);
    }

    /** set_property with a signal-bound max_lines value. */
    public static byte[] txBindMaxLines(long widgetId, long signalId) {
        Enc b = begin(TX_KIND_SET_PROPERTY);
        b.putLong(widgetId).putInt(PROP_MAX_LINES).putInt(SOURCE_SIGNAL).putLong(signalId);
        return finish(b);
    }
    ...
    public static byte[] txSetWindowAppearance(long window, long appearance) {
        Enc b = begin(TX_KIND_SET_WINDOW_PROP);
        b.putLong(window).putInt(WPROP_APPEARANCE).putInt(SOURCE_CONST);
        encodeValue(b, appearance);
        return finish(b);
    }
