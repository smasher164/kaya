...
TMP="$(mktemp -d)"
trap 'rm -rf "$TMP"' EXIT
for example in guests/swift/milestone2.swift guests/swift/entry.swift guests/swift/gallery.swift guests/swift/todos.swift guests/swift/reorder.swift; do
