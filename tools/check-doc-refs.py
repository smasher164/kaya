...
over = sample_text + "\nSee tools/check-doc-refs.py:999999 for this.\n"
under = sample_text + "\nSee tools/check-doc-refs.py:10 for this.\n"
own_len = len((root / "tools" / "check-doc-refs.py")
              .read_text(encoding="utf-8").splitlines())
print(f"check-doc-refs: self-test N6 cited line 999999 and line 10 of "
      f"tools/check-doc-refs.py, which has {own_len} lines -> "
...
MORTAL_SELF = "tools/check-doc-refs.py"
MORTAL_FLOOR = 400
