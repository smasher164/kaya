...
func generateRecord(_ name: String, _ fields: [Field]) -> String {
    ...
    line("")
    line("    func slider(")
    line("        min: Double = 0.0, max: Double = 1.0, value f: KayaField<Double>,")
    line("        step: Double? = nil, tickSpacing: Double? = nil,")
    line("        onChange: ((KayaAppTx, [KayaValue], Double) -> Void)? = nil,")
    line("        onCommit: ((KayaAppTx, [KayaValue], Double) -> Void)? = nil")
    line("    ) -> KayaNodeHandle {")
    line("        t.slider(")
    line("            min: min, max: max, value: f, step: step, tickSpacing: tickSpacing,")
    line("            onChange: onChange, onCommit: onCommit)")
    line("    }")
    line("")
    line("    func row(@KayaNodeChildren _ children: () -> Void) -> KayaNodeHandle {")
    line("        t.row(children)")
