...
rmdir /s /q C:\kaya\legs\sheet_js 2>nul
mkdir C:\kaya\legs\sheet_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sheet_js\state
set KAYA_SELFTEST=sheet
set KAYA_VERB_TRACE=C:\kaya\flightrec\sheet_js-vtrace.txt
node C:\kaya\sheet.ts > C:\kaya\out_sheet_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sheet_js.txt
