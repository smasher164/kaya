...
rmdir /s /q C:\kaya\legs\search_python 2>nul
mkdir C:\kaya\legs\search_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\search_python\state
set KAYA_SELFTEST=search
set KAYA_VERB_TRACE=C:\kaya\flightrec\search_python-vtrace.txt
...
python C:\kaya\search.py > C:\kaya\out_search_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_search_python.txt
