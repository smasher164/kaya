...
rmdir /s /q C:\kaya\legs\varied_python 2>nul
mkdir C:\kaya\legs\varied_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\varied_python\state
set KAYA_SELFTEST=varied
set KAYA_VERB_TRACE=C:\kaya\flightrec\varied_python-vtrace.txt
python C:\kaya\varied.py > C:\kaya\out_varied_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_varied_python.txt
