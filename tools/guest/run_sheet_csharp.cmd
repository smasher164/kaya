...
rmdir /s /q C:\kaya\legs\sheet_csharp 2>nul
mkdir C:\kaya\legs\sheet_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sheet_csharp\state
set KAYA_SELFTEST=sheet
set KAYA_VERB_TRACE=C:\kaya\flightrec\sheet_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_sheet_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sheet_csharp.txt
