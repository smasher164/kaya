...
rmdir /s /q C:\kaya\legs\adaptive_java 2>nul
mkdir C:\kaya\legs\adaptive_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\adaptive_java\state
set KAYA_SELFTEST=adaptive
set KAYA_VERB_TRACE=C:\kaya\flightrec\adaptive_java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_adaptive_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_adaptive_java.txt
