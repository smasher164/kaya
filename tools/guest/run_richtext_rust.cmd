...
rmdir /s /q C:\kaya\legs\richtext_rust 2>nul
mkdir C:\kaya\legs\richtext_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\richtext_rust\state
set KAYA_SELFTEST=richtext
set KAYA_VERB_TRACE=C:\kaya\flightrec\richtext_rust-vtrace.txt
richtext.exe > C:\kaya\out_richtext_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_richtext_rust.txt
