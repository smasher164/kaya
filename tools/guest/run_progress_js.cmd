...
rmdir /s /q C:\kaya\legs\progress_js 2>nul
mkdir C:\kaya\legs\progress_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\progress_js\state
set KAYA_SELFTEST=progress
set KAYA_VERB_TRACE=C:\kaya\flightrec\progress_js-vtrace.txt
