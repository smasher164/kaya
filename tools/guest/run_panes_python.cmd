...
rmdir /s /q C:\kaya\legs\panes_python 2>nul
mkdir C:\kaya\legs\panes_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panes_python\state
set KAYA_SELFTEST=panes
set KAYA_VERB_TRACE=C:\kaya\flightrec\panes_python-vtrace.txt
