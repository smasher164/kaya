...
rmdir /s /q C:\kaya\legs\dnd_python 2>nul
mkdir C:\kaya\legs\dnd_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\dnd_python\state
set KAYA_SELFTEST=dnd
set KAYA_VERB_TRACE=C:\kaya\flightrec\dnd_python-vtrace.txt
...
python C:\kaya\dnd.py > C:\kaya\out_dnd_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_dnd_python.txt
