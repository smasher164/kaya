...
rmdir /s /q C:\kaya\legs\window_js 2>nul
mkdir C:\kaya\legs\window_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\window_js\state
set KAYA_SELFTEST=window
set KAYA_VERB_TRACE=C:\kaya\flightrec\window_js-vtrace.txt
node C:\kaya\window.ts > C:\kaya\out_window_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_window_js.txt
