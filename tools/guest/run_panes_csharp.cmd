...
rmdir /s /q C:\kaya\legs\panes_csharp 2>nul
mkdir C:\kaya\legs\panes_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panes_csharp\state
set KAYA_SELFTEST=panes
set KAYA_VERB_TRACE=C:\kaya\flightrec\panes_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_panes_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_panes_csharp.txt
