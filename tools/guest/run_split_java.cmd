...
rmdir /s /q C:\kaya\legs\split_java 2>nul
mkdir C:\kaya\legs\split_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\split_java\state
set KAYA_SELFTEST=split
set KAYA_VERB_TRACE=C:\kaya\flightrec\split_java-vtrace.txt
