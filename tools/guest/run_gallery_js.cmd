...
rmdir /s /q C:\kaya\legs\gallery_js 2>nul
mkdir C:\kaya\legs\gallery_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\gallery_js\state
set KAYA_SELFTEST=gallery
set KAYA_VERB_TRACE=C:\kaya\flightrec\gallery_js-vtrace.txt
node C:\kaya\gallery.ts > C:\kaya\out_gallery_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_gallery_js.txt
