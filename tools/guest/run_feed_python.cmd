...
rmdir /s /q C:\kaya\legs\feed_python 2>nul
mkdir C:\kaya\legs\feed_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\feed_python\state
set KAYA_SELFTEST=feed
set KAYA_VERB_TRACE=C:\kaya\flightrec\feed_python-vtrace.txt
