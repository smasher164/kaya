...
rmdir /s /q C:\kaya\legs\editor_go 2>nul
mkdir C:\kaya\legs\editor_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\editor_go\state
set KAYA_SELFTEST=editor
set KAYA_VERB_TRACE=C:\kaya\flightrec\editor_go-vtrace.txt
...
go build -o C:\kaya\editor_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_editor_go.txt 2>&1
if errorlevel 1 goto done
editor_go.exe >> C:\kaya\out_editor_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_editor_go.txt
