...
rmdir /s /q C:\kaya\legs\background_js 2>nul
mkdir C:\kaya\legs\background_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\background_js\state
set KAYA_SELFTEST=background
set KAYA_VERB_TRACE=C:\kaya\flightrec\background_js-vtrace.txt
node C:\kaya\background.ts > C:\kaya\out_background_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_background_js.txt
