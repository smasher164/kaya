...
rmdir /s /q C:\kaya\legs\scrollto_rust 2>nul
mkdir C:\kaya\legs\scrollto_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scrollto_rust\state
set KAYA_SELFTEST=scrollto
set KAYA_VERB_TRACE=C:\kaya\flightrec\scrollto_rust-vtrace.txt
scrollto.exe > C:\kaya\out_scrollto_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scrollto_rust.txt
