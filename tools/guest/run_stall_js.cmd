...
rmdir /s /q C:\kaya\legs\stall_js 2>nul
mkdir C:\kaya\legs\stall_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\stall_js\state
set KAYA_SELFTEST=stall
set KAYA_VERB_TRACE=C:\kaya\flightrec\stall_js-vtrace.txt
