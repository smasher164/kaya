...
rmdir /s /q C:\kaya\legs\select_python 2>nul
mkdir C:\kaya\legs\select_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\select_python\state
set KAYA_SELFTEST=select
set KAYA_VERB_TRACE=C:\kaya\flightrec\select_python-vtrace.txt
