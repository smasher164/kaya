...
rmdir /s /q C:\kaya\legs\richlabel_rust 2>nul
mkdir C:\kaya\legs\richlabel_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\richlabel_rust\state
set KAYA_SELFTEST=richlabel
set KAYA_VERB_TRACE=C:\kaya\flightrec\richlabel_rust-vtrace.txt
richlabel.exe > C:\kaya\out_richlabel_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_richlabel_rust.txt
