...
rmdir /s /q C:\kaya\legs\taskspersist_rust 2>nul
mkdir C:\kaya\legs\taskspersist_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\taskspersist_rust\state
set KAYA_SELFTEST=taskspersist
set KAYA_VERB_TRACE=C:\kaya\flightrec\taskspersist_rust-vtrace.txt
tasks.exe > C:\kaya\out_taskspersist_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_taskspersist_rust.txt
