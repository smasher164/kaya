...
rmdir /s /q C:\kaya\legs\entry_js 2>nul
mkdir C:\kaya\legs\entry_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\entry_js\state
set KAYA_SELFTEST=entry
set KAYA_VERB_TRACE=C:\kaya\flightrec\entry_js-vtrace.txt
node C:\kaya\entry.ts > C:\kaya\out_entry_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_entry_js.txt
