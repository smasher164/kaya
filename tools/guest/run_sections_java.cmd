...
rmdir /s /q C:\kaya\legs\sections_java 2>nul
mkdir C:\kaya\legs\sections_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sections_java\state
set KAYA_SELFTEST=sections
set KAYA_VERB_TRACE=C:\kaya\flightrec\sections_java-vtrace.txt
...
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_sections_java.txt 2>&1
