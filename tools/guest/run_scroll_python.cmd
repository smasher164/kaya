...
rmdir /s /q C:\kaya\legs\scroll_python 2>nul
mkdir C:\kaya\legs\scroll_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scroll_python\state
set KAYA_SELFTEST=scroll
set KAYA_VERB_TRACE=C:\kaya\flightrec\scroll_python-vtrace.txt
