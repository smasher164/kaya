...
rmdir /s /q C:\kaya\legs\pickers_go 2>nul
mkdir C:\kaya\legs\pickers_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\pickers_go\state
set KAYA_SELFTEST=pickers
set KAYA_VERB_TRACE=C:\kaya\flightrec\pickers_go-vtrace.txt
...
go build -o C:\kaya\pickers_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_pickers_go.txt 2>&1
if errorlevel 1 goto done
pickers_go.exe >> C:\kaya\out_pickers_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_pickers_go.txt
