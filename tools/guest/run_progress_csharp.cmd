...
rmdir /s /q C:\kaya\legs\progress_csharp 2>nul
mkdir C:\kaya\legs\progress_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\progress_csharp\state
set KAYA_SELFTEST=progress
set KAYA_VERB_TRACE=C:\kaya\flightrec\progress_csharp-vtrace.txt
