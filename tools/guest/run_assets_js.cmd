...
rmdir /s /q C:\kaya\legs\assets_js 2>nul
mkdir C:\kaya\legs\assets_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\assets_js\state
set KAYA_SELFTEST=assets
set KAYA_VERB_TRACE=C:\kaya\flightrec\assets_js-vtrace.txt
node C:\kaya\assets.ts > C:\kaya\out_assets_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_assets_js.txt
