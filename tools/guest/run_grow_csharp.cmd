...
rmdir /s /q C:\kaya\legs\grow_csharp 2>nul
mkdir C:\kaya\legs\grow_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\grow_csharp\state
set KAYA_SELFTEST=grow
set KAYA_VERB_TRACE=C:\kaya\flightrec\grow_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_grow_csharp.txt 2>&1
