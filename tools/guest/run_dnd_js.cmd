...
rmdir /s /q C:\kaya\legs\dnd_js 2>nul
mkdir C:\kaya\legs\dnd_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\dnd_js\state
set KAYA_SELFTEST=dnd
set KAYA_VERB_TRACE=C:\kaya\flightrec\dnd_js-vtrace.txt
node C:\kaya\dnd.ts > C:\kaya\out_dnd_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_dnd_js.txt
