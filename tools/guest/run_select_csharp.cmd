...
rmdir /s /q C:\kaya\legs\select_csharp 2>nul
mkdir C:\kaya\legs\select_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\select_csharp\state
set KAYA_SELFTEST=select
set KAYA_VERB_TRACE=C:\kaya\flightrec\select_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_select_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_select_csharp.txt
