...
rmdir /s /q C:\kaya\legs\confirm_java 2>nul
mkdir C:\kaya\legs\confirm_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\confirm_java\state
set KAYA_SELFTEST=confirm
set KAYA_VERB_TRACE=C:\kaya\flightrec\confirm_java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_confirm_java.txt 2>&1
