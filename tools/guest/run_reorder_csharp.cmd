...
rmdir /s /q C:\kaya\legs\reorder_csharp 2>nul
mkdir C:\kaya\legs\reorder_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\reorder_csharp\state
set KAYA_SELFTEST=reorder
set KAYA_VERB_TRACE=C:\kaya\flightrec\reorder_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_reorder_csharp.txt 2>&1
