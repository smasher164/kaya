...
rmdir /s /q C:\kaya\legs\gallery_python 2>nul
mkdir C:\kaya\legs\gallery_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\gallery_python\state
set KAYA_SELFTEST=gallery
set KAYA_VERB_TRACE=C:\kaya\flightrec\gallery_python-vtrace.txt
