...
rmdir /s /q C:\kaya\legs\todos_csharp 2>nul
mkdir C:\kaya\legs\todos_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\todos_csharp\state
set KAYA_SELFTEST=todos
set KAYA_VERB_TRACE=C:\kaya\flightrec\todos_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_todos_csharp.txt 2>&1
