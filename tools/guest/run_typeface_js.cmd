...
rmdir /s /q C:\kaya\legs\typeface_js 2>nul
mkdir C:\kaya\legs\typeface_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\typeface_js\state
set KAYA_SELFTEST=typeface
set KAYA_VERB_TRACE=C:\kaya\flightrec\typeface_js-vtrace.txt
node C:\kaya\typeface.ts > C:\kaya\out_typeface_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_typeface_js.txt
