...
rmdir /s /q C:\kaya\legs\formatbig_rust 2>nul
mkdir C:\kaya\legs\formatbig_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatbig_rust\state
set KAYA_SELFTEST=formatbig
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatbig_rust-vtrace.txt
format.exe > C:\kaya\out_formatbig_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatbig_rust.txt
