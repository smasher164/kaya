...
rmdir /s /q C:\kaya\legs\format_rust 2>nul
mkdir C:\kaya\legs\format_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\format_rust\state
set KAYA_SELFTEST=format
set KAYA_VERB_TRACE=C:\kaya\flightrec\format_rust-vtrace.txt
format.exe > C:\kaya\out_format_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_format_rust.txt
