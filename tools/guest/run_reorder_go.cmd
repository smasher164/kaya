...
rmdir /s /q C:\kaya\legs\reorder_go 2>nul
mkdir C:\kaya\legs\reorder_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\reorder_go\state
set KAYA_SELFTEST=reorder
set KAYA_VERB_TRACE=C:\kaya\flightrec\reorder_go-vtrace.txt
...
go build -o C:\kaya\reorder_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_reorder_go.txt 2>&1
if errorlevel 1 goto done
reorder_go.exe >> C:\kaya\out_reorder_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_reorder_go.txt
