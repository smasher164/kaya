...
rmdir /s /q C:\kaya\legs\ownundo_rust 2>nul
mkdir C:\kaya\legs\ownundo_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\ownundo_rust\state
set KAYA_SELFTEST=ownundo
set KAYA_VERB_TRACE=C:\kaya\flightrec\ownundo_rust-vtrace.txt
ownundo.exe > C:\kaya\out_ownundo_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_ownundo_rust.txt
