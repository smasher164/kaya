...
rmdir /s /q C:\kaya\legs\grid_js 2>nul
mkdir C:\kaya\legs\grid_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\grid_js\state
set KAYA_SELFTEST=grid
set KAYA_VERB_TRACE=C:\kaya\flightrec\grid_js-vtrace.txt
node C:\kaya\grid.ts > C:\kaya\out_grid_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_grid_js.txt
