...
rmdir /s /q C:\kaya\legs\search_csharp 2>nul
mkdir C:\kaya\legs\search_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\search_csharp\state
set KAYA_SELFTEST=search
set KAYA_VERB_TRACE=C:\kaya\flightrec\search_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_search_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_search_csharp.txt
