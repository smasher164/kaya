...
rmdir /s /q C:\kaya\legs\scrollto_python 2>nul
mkdir C:\kaya\legs\scrollto_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scrollto_python\state
set KAYA_SELFTEST=scrollto
set KAYA_VERB_TRACE=C:\kaya\flightrec\scrollto_python-vtrace.txt
...
python C:\kaya\scrollto.py > C:\kaya\out_scrollto_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scrollto_python.txt
