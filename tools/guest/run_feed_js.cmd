...
rmdir /s /q C:\kaya\legs\feed_js 2>nul
mkdir C:\kaya\legs\feed_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\feed_js\state
set KAYA_SELFTEST=feed
set KAYA_VERB_TRACE=C:\kaya\flightrec\feed_js-vtrace.txt
node C:\kaya\feed.ts > C:\kaya\out_feed_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_feed_js.txt
