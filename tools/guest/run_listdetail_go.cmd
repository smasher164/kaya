...
rmdir /s /q C:\kaya\legs\listdetail_go 2>nul
mkdir C:\kaya\legs\listdetail_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_go\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_go-vtrace.txt
...
go build -o C:\kaya\split_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_listdetail_go.txt 2>&1
if errorlevel 1 goto done
split_go.exe >> C:\kaya\out_listdetail_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_listdetail_go.txt
