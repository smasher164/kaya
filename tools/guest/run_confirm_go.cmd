...
rmdir /s /q C:\kaya\legs\confirm_go 2>nul
mkdir C:\kaya\legs\confirm_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\confirm_go\state
set KAYA_SELFTEST=confirm
set KAYA_VERB_TRACE=C:\kaya\flightrec\confirm_go-vtrace.txt
...
go build -o C:\kaya\confirm_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_confirm_go.txt 2>&1
if errorlevel 1 goto done
confirm_go.exe >> C:\kaya\out_confirm_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_confirm_go.txt
