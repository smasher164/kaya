...
rmdir /s /q C:\kaya\legs\sheet_go 2>nul
mkdir C:\kaya\legs\sheet_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sheet_go\state
set KAYA_SELFTEST=sheet
set KAYA_VERB_TRACE=C:\kaya\flightrec\sheet_go-vtrace.txt
...
go build -o C:\kaya\sheet_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_sheet_go.txt 2>&1
if errorlevel 1 goto done
sheet_go.exe >> C:\kaya\out_sheet_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sheet_go.txt
