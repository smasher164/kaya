...
rmdir /s /q C:\kaya\legs\confirm_js 2>nul
mkdir C:\kaya\legs\confirm_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\confirm_js\state
set KAYA_SELFTEST=confirm
set KAYA_VERB_TRACE=C:\kaya\flightrec\confirm_js-vtrace.txt
node C:\kaya\confirm.ts > C:\kaya\out_confirm_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_confirm_js.txt
