...
rmdir /s /q C:\kaya\legs\csharp 2>nul
mkdir C:\kaya\legs\csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\csharp\state
set KAYA_SELFTEST=1
set KAYA_VERB_TRACE=C:\kaya\flightrec\csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_csharp.txt
