...
rmdir /s /q C:\kaya\legs\java 2>nul
mkdir C:\kaya\legs\java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\java\state
set KAYA_SELFTEST=1
set KAYA_VERB_TRACE=C:\kaya\flightrec\java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_java.txt 2>&1
