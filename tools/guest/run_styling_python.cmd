...
rmdir /s /q C:\kaya\legs\styling_python 2>nul
mkdir C:\kaya\legs\styling_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\styling_python\state
set KAYA_SELFTEST=styling
set KAYA_VERB_TRACE=C:\kaya\flightrec\styling_python-vtrace.txt
...
python C:\kaya\styling.py > C:\kaya\out_styling_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_styling_python.txt
