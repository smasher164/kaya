...
rmdir /s /q C:\kaya\legs\listdetail_java 2>nul
mkdir C:\kaya\legs\listdetail_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_java\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_java-vtrace.txt
