...
rmdir /s /q C:\kaya\legs\chat_go 2>nul
mkdir C:\kaya\legs\chat_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\chat_go\state
set KAYA_SELFTEST=chat
set KAYA_VERB_TRACE=C:\kaya\flightrec\chat_go-vtrace.txt
...
go build -o C:\kaya\chat_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_chat_go.txt 2>&1
if errorlevel 1 goto done
chat_go.exe >> C:\kaya\out_chat_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_chat_go.txt
