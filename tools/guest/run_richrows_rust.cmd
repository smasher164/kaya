...
rmdir /s /q C:\kaya\legs\richrows_rust 2>nul
mkdir C:\kaya\legs\richrows_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\richrows_rust\state
set KAYA_SELFTEST=richrows
set KAYA_VERB_TRACE=C:\kaya\flightrec\richrows_rust-vtrace.txt
richrows.exe > C:\kaya\out_richrows_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_richrows_rust.txt
