...
rmdir /s /q C:\kaya\legs\panels_csharp 2>nul
mkdir C:\kaya\legs\panels_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panels_csharp\state
set KAYA_SELFTEST=panels
set KAYA_VERB_TRACE=C:\kaya\flightrec\panels_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_panels_csharp.txt 2>&1
