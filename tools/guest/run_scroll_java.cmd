...
rmdir /s /q C:\kaya\legs\scroll_java 2>nul
mkdir C:\kaya\legs\scroll_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scroll_java\state
set KAYA_SELFTEST=scroll
set KAYA_VERB_TRACE=C:\kaya\flightrec\scroll_java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_scroll_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scroll_java.txt
