...
rmdir /s /q C:\kaya\legs\sections_js 2>nul
mkdir C:\kaya\legs\sections_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sections_js\state
set KAYA_SELFTEST=sections
set KAYA_VERB_TRACE=C:\kaya\flightrec\sections_js-vtrace.txt
node C:\kaya\sections.ts > C:\kaya\out_sections_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sections_js.txt
