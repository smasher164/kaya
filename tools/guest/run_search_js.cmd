...
rmdir /s /q C:\kaya\legs\search_js 2>nul
mkdir C:\kaya\legs\search_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\search_js\state
set KAYA_SELFTEST=search
set KAYA_VERB_TRACE=C:\kaya\flightrec\search_js-vtrace.txt
node C:\kaya\search.ts > C:\kaya\out_search_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_search_js.txt
