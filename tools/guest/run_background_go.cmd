...
rmdir /s /q C:\kaya\legs\background_go 2>nul
mkdir C:\kaya\legs\background_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\background_go\state
set KAYA_SELFTEST=background
set KAYA_VERB_TRACE=C:\kaya\flightrec\background_go-vtrace.txt
...
go build -o C:\kaya\background_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_background_go.txt 2>&1
if errorlevel 1 goto done
background_go.exe >> C:\kaya\out_background_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_background_go.txt
