...
rmdir /s /q C:\kaya\legs\split_csharp 2>nul
mkdir C:\kaya\legs\split_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\split_csharp\state
set KAYA_SELFTEST=split
set KAYA_VERB_TRACE=C:\kaya\flightrec\split_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_split_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_split_csharp.txt
