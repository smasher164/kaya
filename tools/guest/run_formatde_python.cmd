...
rmdir /s /q C:\kaya\legs\formatde_python 2>nul
mkdir C:\kaya\legs\formatde_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatde_python\state
set KAYA_LOCALE=de-DE
set KAYA_SELFTEST=formatde
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatde_python-vtrace.txt
python C:\kaya\format.py > C:\kaya\out_formatde_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatde_python.txt
