...
rmdir /s /q C:\kaya\legs\toolbar_python 2>nul
mkdir C:\kaya\legs\toolbar_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\toolbar_python\state
...
python C:\kaya\toolbar.py > C:\kaya\out_toolbar_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_toolbar_python.txt
