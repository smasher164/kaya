...
rmdir /s /q C:\kaya\legs\radio_python 2>nul
mkdir C:\kaya\legs\radio_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\radio_python\state
set KAYA_SELFTEST=radio
set KAYA_VERB_TRACE=C:\kaya\flightrec\radio_python-vtrace.txt
