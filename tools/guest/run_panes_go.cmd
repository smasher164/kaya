...
rmdir /s /q C:\kaya\legs\panes_go 2>nul
mkdir C:\kaya\legs\panes_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panes_go\state
set KAYA_SELFTEST=panes
set KAYA_VERB_TRACE=C:\kaya\flightrec\panes_go-vtrace.txt
...
go build -o C:\kaya\panes_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_panes_go.txt 2>&1
if errorlevel 1 goto done
panes_go.exe >> C:\kaya\out_panes_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_panes_go.txt
