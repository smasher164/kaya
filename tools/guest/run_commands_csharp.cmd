...
rmdir /s /q C:\kaya\legs\commands_csharp 2>nul
mkdir C:\kaya\legs\commands_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\commands_csharp\state
set KAYA_SELFTEST=commands
set KAYA_VERB_TRACE=C:\kaya\flightrec\commands_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_commands_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_commands_csharp.txt
