...
rmdir /s /q C:\kaya\legs\layout_csharp 2>nul
mkdir C:\kaya\legs\layout_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\layout_csharp\state
set KAYA_SELFTEST=layout
set KAYA_VERB_TRACE=C:\kaya\flightrec\layout_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_layout_csharp.txt 2>&1
