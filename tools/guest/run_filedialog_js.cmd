...
rmdir /s /q C:\kaya\legs\filedialog_js 2>nul
mkdir C:\kaya\legs\filedialog_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\filedialog_js\state
set KAYA_SELFTEST=filedialog
set KAYA_VERB_TRACE=C:\kaya\flightrec\filedialog_js-vtrace.txt
