...
rmdir /s /q C:\kaya\legs\adaptive_js 2>nul
mkdir C:\kaya\legs\adaptive_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\adaptive_js\state
set KAYA_SELFTEST=adaptive
set KAYA_VERB_TRACE=C:\kaya\flightrec\adaptive_js-vtrace.txt
node C:\kaya\adaptive.ts > C:\kaya\out_adaptive_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_adaptive_js.txt
