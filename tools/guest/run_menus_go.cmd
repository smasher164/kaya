...
rmdir /s /q C:\kaya\legs\menus_go 2>nul
mkdir C:\kaya\legs\menus_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\menus_go\state
set KAYA_SELFTEST=menus
set KAYA_VERB_TRACE=C:\kaya\flightrec\menus_go-vtrace.txt
...
go build -o C:\kaya\menus_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_menus_go.txt 2>&1
if errorlevel 1 goto done
menus_go.exe >> C:\kaya\out_menus_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_menus_go.txt
