...
rmdir /s /q C:\kaya\legs\clock24_rust 2>nul
mkdir C:\kaya\legs\clock24_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\clock24_rust\state
set KAYA_SELFTEST=clock24
set KAYA_VERB_TRACE=C:\kaya\flightrec\clock24_rust-vtrace.txt
format.exe > C:\kaya\out_clock24_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_clock24_rust.txt
