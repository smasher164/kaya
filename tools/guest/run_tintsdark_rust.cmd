...
rmdir /s /q C:\kaya\legs\tintsdark_rust 2>nul
mkdir C:\kaya\legs\tintsdark_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\tintsdark_rust\state
set KAYA_SELFTEST=tints
set KAYA_VERB_TRACE=C:\kaya\flightrec\tintsdark_rust-vtrace.txt
tints.exe > C:\kaya\out_tintsdark_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_tintsdark_rust.txt
