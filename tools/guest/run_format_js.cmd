...
rmdir /s /q C:\kaya\legs\format_js 2>nul
mkdir C:\kaya\legs\format_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\format_js\state
set KAYA_SELFTEST=format
set KAYA_VERB_TRACE=C:\kaya\flightrec\format_js-vtrace.txt
node C:\kaya\format.ts > C:\kaya\out_format_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_format_js.txt
