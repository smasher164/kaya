...
rmdir /s /q C:\kaya\legs\adaptive_python 2>nul
mkdir C:\kaya\legs\adaptive_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\adaptive_python\state
set KAYA_SELFTEST=adaptive
set KAYA_VERB_TRACE=C:\kaya\flightrec\adaptive_python-vtrace.txt
