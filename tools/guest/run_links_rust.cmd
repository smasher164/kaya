...
rmdir /s /q C:\kaya\legs\links_rust 2>nul
mkdir C:\kaya\legs\links_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\links_rust\state
set KAYA_SELFTEST=links
set KAYA_VERB_TRACE=C:\kaya\flightrec\links_rust-vtrace.txt
tasks.exe > C:\kaya\out_links_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_links_rust.txt
