...
rmdir /s /q C:\kaya\legs\scrollto_js 2>nul
mkdir C:\kaya\legs\scrollto_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scrollto_js\state
set KAYA_SELFTEST=scrollto
set KAYA_VERB_TRACE=C:\kaya\flightrec\scrollto_js-vtrace.txt
node C:\kaya\scrollto.ts > C:\kaya\out_scrollto_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scrollto_js.txt
