...
rmdir /s /q C:\kaya\legs\sheet_python 2>nul
mkdir C:\kaya\legs\sheet_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sheet_python\state
set KAYA_SELFTEST=sheet
set KAYA_VERB_TRACE=C:\kaya\flightrec\sheet_python-vtrace.txt
python C:\kaya\sheet.py > C:\kaya\out_sheet_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sheet_python.txt
