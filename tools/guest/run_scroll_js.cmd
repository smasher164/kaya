...
rmdir /s /q C:\kaya\legs\scroll_js 2>nul
mkdir C:\kaya\legs\scroll_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scroll_js\state
set KAYA_SELFTEST=scroll
set KAYA_VERB_TRACE=C:\kaya\flightrec\scroll_js-vtrace.txt
node C:\kaya\scroll.ts > C:\kaya\out_scroll_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scroll_js.txt
