...
rmdir /s /q C:\kaya\legs\a11y_java 2>nul
mkdir C:\kaya\legs\a11y_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11y_java\state
set KAYA_SELFTEST=a11y
set KAYA_VERB_TRACE=C:\kaya\flightrec\a11y_java-vtrace.txt
...
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_a11y_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_a11y_java.txt
