...
rmdir /s /q C:\kaya\legs\pickers_python 2>nul
mkdir C:\kaya\legs\pickers_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\pickers_python\state
set KAYA_SELFTEST=pickers
set KAYA_VERB_TRACE=C:\kaya\flightrec\pickers_python-vtrace.txt
