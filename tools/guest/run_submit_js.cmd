...
rmdir /s /q C:\kaya\legs\submit_js 2>nul
mkdir C:\kaya\legs\submit_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\submit_js\state
set KAYA_SELFTEST=submit
set KAYA_VERB_TRACE=C:\kaya\flightrec\submit_js-vtrace.txt
node C:\kaya\submit.ts > C:\kaya\out_submit_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_submit_js.txt
