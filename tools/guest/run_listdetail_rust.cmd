...
rmdir /s /q C:\kaya\legs\listdetail_rust 2>nul
mkdir C:\kaya\legs\listdetail_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_rust\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_rust-vtrace.txt
split.exe > C:\kaya\out_listdetail_rust.txt 2>&1
