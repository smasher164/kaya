...
rmdir /s /q C:\kaya\legs\a11y_python 2>nul
mkdir C:\kaya\legs\a11y_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11y_python\state
set KAYA_SELFTEST=a11y
set KAYA_VERB_TRACE=C:\kaya\flightrec\a11y_python-vtrace.txt
