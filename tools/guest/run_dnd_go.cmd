...
rmdir /s /q C:\kaya\legs\dnd_go 2>nul
mkdir C:\kaya\legs\dnd_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\dnd_go\state
set KAYA_SELFTEST=dnd
set KAYA_VERB_TRACE=C:\kaya\flightrec\dnd_go-vtrace.txt
...
go build -o C:\kaya\dnd_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_dnd_go.txt 2>&1
if errorlevel 1 goto done
dnd_go.exe >> C:\kaya\out_dnd_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_dnd_go.txt
