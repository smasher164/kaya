...
rmdir /s /q C:\kaya\legs\a11yrows_js 2>nul
mkdir C:\kaya\legs\a11yrows_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11yrows_js\state
set KAYA_SELFTEST=a11yrows
set KAYA_VERB_TRACE=C:\kaya\flightrec\a11yrows_js-vtrace.txt
node C:\kaya\a11yrows.ts > C:\kaya\out_a11yrows_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_a11yrows_js.txt
