...
rmdir /s /q C:\kaya\legs\pickers_js 2>nul
mkdir C:\kaya\legs\pickers_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\pickers_js\state
set KAYA_SELFTEST=pickers
set KAYA_VERB_TRACE=C:\kaya\flightrec\pickers_js-vtrace.txt
