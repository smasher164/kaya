...
rmdir /s /q C:\kaya\legs\dnd_csharp 2>nul
mkdir C:\kaya\legs\dnd_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\dnd_csharp\state
set KAYA_SELFTEST=dnd
set KAYA_VERB_TRACE=C:\kaya\flightrec\dnd_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_dnd_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_dnd_csharp.txt
