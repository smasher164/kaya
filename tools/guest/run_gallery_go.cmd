...
rmdir /s /q C:\kaya\legs\gallery_go 2>nul
mkdir C:\kaya\legs\gallery_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\gallery_go\state
...
go build -o C:\kaya\gallery_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_gallery_go.txt 2>&1
if errorlevel 1 goto done
gallery_go.exe >> C:\kaya\out_gallery_go.txt 2>&1
:done
