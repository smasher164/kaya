...
rmdir /s /q C:\kaya\legs\panels_js 2>nul
mkdir C:\kaya\legs\panels_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panels_js\state
set KAYA_SELFTEST=panels
set KAYA_VERB_TRACE=C:\kaya\flightrec\panels_js-vtrace.txt
node C:\kaya\panels.ts > C:\kaya\out_panels_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_panels_js.txt
