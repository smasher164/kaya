...
rmdir /s /q C:\kaya\legs\table_js 2>nul
mkdir C:\kaya\legs\table_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\table_js\state
set KAYA_SELFTEST=table
set KAYA_VERB_TRACE=C:\kaya\flightrec\table_js-vtrace.txt
node C:\kaya\table.ts > C:\kaya\out_table_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_table_js.txt
