...
rmdir /s /q C:\kaya\legs\radio_csharp 2>nul
mkdir C:\kaya\legs\radio_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\radio_csharp\state
set KAYA_SELFTEST=radio
set KAYA_VERB_TRACE=C:\kaya\flightrec\radio_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_radio_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_radio_csharp.txt
