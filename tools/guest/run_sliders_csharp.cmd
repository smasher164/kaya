...
rmdir /s /q C:\kaya\legs\sliders_csharp 2>nul
mkdir C:\kaya\legs\sliders_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sliders_csharp\state
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_sliders_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sliders_csharp.txt
