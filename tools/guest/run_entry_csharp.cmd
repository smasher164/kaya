...
rmdir /s /q C:\kaya\legs\entry_csharp 2>nul
mkdir C:\kaya\legs\entry_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\entry_csharp\state
set KAYA_SELFTEST=entry
set KAYA_VERB_TRACE=C:\kaya\flightrec\entry_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_entry_csharp.txt 2>&1
