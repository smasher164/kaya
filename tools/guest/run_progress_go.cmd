...
rmdir /s /q C:\kaya\legs\progress_go 2>nul
mkdir C:\kaya\legs\progress_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\progress_go\state
set KAYA_SELFTEST=progress
set KAYA_VERB_TRACE=C:\kaya\flightrec\progress_go-vtrace.txt
