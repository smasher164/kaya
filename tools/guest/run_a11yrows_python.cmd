...
rmdir /s /q C:\kaya\legs\a11yrows_python 2>nul
mkdir C:\kaya\legs\a11yrows_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11yrows_python\state
set KAYA_SELFTEST=a11yrows
set KAYA_VERB_TRACE=C:\kaya\flightrec\a11yrows_python-vtrace.txt
