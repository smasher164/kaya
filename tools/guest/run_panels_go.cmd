...
rmdir /s /q C:\kaya\legs\panels_go 2>nul
mkdir C:\kaya\legs\panels_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panels_go\state
set KAYA_SELFTEST=panels
set KAYA_VERB_TRACE=C:\kaya\flightrec\panels_go-vtrace.txt
