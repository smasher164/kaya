...
rmdir /s /q C:\kaya\legs\identity_js 2>nul
mkdir C:\kaya\legs\identity_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\identity_js\state
set KAYA_SELFTEST=identity
set KAYA_VERB_TRACE=C:\kaya\flightrec\identity_js-vtrace.txt
node C:\kaya\identity.ts > C:\kaya\out_identity_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_identity_js.txt
