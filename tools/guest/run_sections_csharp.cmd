...
rmdir /s /q C:\kaya\legs\sections_csharp 2>nul
mkdir C:\kaya\legs\sections_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sections_csharp\state
set KAYA_SELFTEST=sections
set KAYA_VERB_TRACE=C:\kaya\flightrec\sections_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_sections_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sections_csharp.txt
