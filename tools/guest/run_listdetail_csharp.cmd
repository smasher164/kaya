...
rmdir /s /q C:\kaya\legs\listdetail_csharp 2>nul
mkdir C:\kaya\legs\listdetail_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_csharp\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_listdetail_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_listdetail_csharp.txt
