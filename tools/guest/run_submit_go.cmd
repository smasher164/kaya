...
rmdir /s /q C:\kaya\legs\submit_go 2>nul
mkdir C:\kaya\legs\submit_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\submit_go\state
set KAYA_SELFTEST=submit
set KAYA_VERB_TRACE=C:\kaya\flightrec\submit_go-vtrace.txt
...
go build -o C:\kaya\submit_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_submit_go.txt 2>&1
if errorlevel 1 goto done
submit_go.exe >> C:\kaya\out_submit_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_submit_go.txt
