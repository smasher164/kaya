...
rmdir /s /q C:\kaya\legs\background_csharp 2>nul
mkdir C:\kaya\legs\background_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\background_csharp\state
set KAYA_SELFTEST=background
set KAYA_VERB_TRACE=C:\kaya\flightrec\background_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_background_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_background_csharp.txt
