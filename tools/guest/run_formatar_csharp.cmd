...
rmdir /s /q C:\kaya\legs\formatar_csharp 2>nul
mkdir C:\kaya\legs\formatar_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatar_csharp\state
set KAYA_LOCALE=ar-EG
set KAYA_SELFTEST=formatar
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatar_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_formatar_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatar_csharp.txt
