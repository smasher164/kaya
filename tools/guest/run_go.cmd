...
rmdir /s /q C:\kaya\legs\go 2>nul
mkdir C:\kaya\legs\go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\go\state
set KAYA_SELFTEST=1
set KAYA_VERB_TRACE=C:\kaya\flightrec\go-vtrace.txt
...
go build -o C:\kaya\milestone2_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_go.txt 2>&1
if errorlevel 1 goto done
milestone2_go.exe >> C:\kaya\out_go.txt 2>&1
:done
