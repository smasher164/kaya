...
rmdir /s /q C:\kaya\legs\panes_js 2>nul
mkdir C:\kaya\legs\panes_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panes_js\state
set KAYA_SELFTEST=panes
set KAYA_VERB_TRACE=C:\kaya\flightrec\panes_js-vtrace.txt
