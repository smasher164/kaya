...
rmdir /s /q C:\kaya\legs\clipboard_js 2>nul
mkdir C:\kaya\legs\clipboard_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\clipboard_js\state
set KAYA_SELFTEST=clipboard
set KAYA_VERB_TRACE=C:\kaya\flightrec\clipboard_js-vtrace.txt
