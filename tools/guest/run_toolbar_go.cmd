...
rmdir /s /q C:\kaya\legs\toolbar_go 2>nul
mkdir C:\kaya\legs\toolbar_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\toolbar_go\state
set KAYA_SELFTEST=toolbar
set KAYA_VERB_TRACE=C:\kaya\flightrec\toolbar_go-vtrace.txt
...
go build -o C:\kaya\toolbar_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_toolbar_go.txt 2>&1
if errorlevel 1 goto done
toolbar_go.exe >> C:\kaya\out_toolbar_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_toolbar_go.txt
