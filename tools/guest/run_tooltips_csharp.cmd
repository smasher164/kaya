...
rmdir /s /q C:\kaya\legs\tooltips_csharp 2>nul
mkdir C:\kaya\legs\tooltips_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\tooltips_csharp\state
set KAYA_SELFTEST=tooltips
set KAYA_VERB_TRACE=C:\kaya\flightrec\tooltips_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_tooltips_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_tooltips_csharp.txt
