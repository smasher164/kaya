...
rmdir /s /q C:\kaya\legs\feed_go 2>nul
mkdir C:\kaya\legs\feed_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\feed_go\state
set KAYA_SELFTEST=feed
set KAYA_VERB_TRACE=C:\kaya\flightrec\feed_go-vtrace.txt
...
go build -o C:\kaya\feed_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_feed_go.txt 2>&1
if errorlevel 1 goto done
feed_go.exe >> C:\kaya\out_feed_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_feed_go.txt
