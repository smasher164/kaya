...
rmdir /s /q C:\kaya\legs\textarea_csharp 2>nul
mkdir C:\kaya\legs\textarea_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\textarea_csharp\state
set KAYA_SELFTEST=textarea
set KAYA_VERB_TRACE=C:\kaya\flightrec\textarea_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_textarea_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_textarea_csharp.txt
