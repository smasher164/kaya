...
rmdir /s /q C:\kaya\legs\a11y_go 2>nul
mkdir C:\kaya\legs\a11y_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11y_go\state
set KAYA_SELFTEST=a11y
set KAYA_VERB_TRACE=C:\kaya\flightrec\a11y_go-vtrace.txt
...
go build -o C:\kaya\a11y_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_a11y_go.txt 2>&1
if errorlevel 1 goto done
a11y_go.exe >> C:\kaya\out_a11y_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_a11y_go.txt
