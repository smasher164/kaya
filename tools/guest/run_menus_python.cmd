...
rmdir /s /q C:\kaya\legs\menus_python 2>nul
mkdir C:\kaya\legs\menus_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\menus_python\state
set KAYA_SELFTEST=menus
set KAYA_VERB_TRACE=C:\kaya\flightrec\menus_python-vtrace.txt
...
python C:\kaya\menus.py > C:\kaya\out_menus_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_menus_python.txt
