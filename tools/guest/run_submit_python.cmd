...
rmdir /s /q C:\kaya\legs\submit_python 2>nul
mkdir C:\kaya\legs\submit_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\submit_python\state
set KAYA_SELFTEST=submit
set KAYA_VERB_TRACE=C:\kaya\flightrec\submit_python-vtrace.txt
...
python C:\kaya\submit.py > C:\kaya\out_submit_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_submit_python.txt
