...
rmdir /s /q C:\kaya\legs\sliders_go 2>nul
mkdir C:\kaya\legs\sliders_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sliders_go\state
set KAYA_SELFTEST=sliders
set KAYA_VERB_TRACE=C:\kaya\flightrec\sliders_go-vtrace.txt
...
go build -o C:\kaya\sliders_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_sliders_go.txt 2>&1
if errorlevel 1 goto done
sliders_go.exe >> C:\kaya\out_sliders_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sliders_go.txt
