...
rmdir /s /q C:\kaya\legs\formatar_rust 2>nul
mkdir C:\kaya\legs\formatar_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatar_rust\state
set KAYA_SELFTEST=formatar
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatar_rust-vtrace.txt
format.exe > C:\kaya\out_formatar_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatar_rust.txt
