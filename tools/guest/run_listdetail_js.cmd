...
rmdir /s /q C:\kaya\legs\listdetail_js 2>nul
mkdir C:\kaya\legs\listdetail_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_js\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_js-vtrace.txt
node C:\kaya\split.ts > C:\kaya\out_listdetail_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_listdetail_js.txt
