...
rmdir /s /q C:\kaya\legs\format_python 2>nul
mkdir C:\kaya\legs\format_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\format_python\state
set KAYA_SELFTEST=format
set KAYA_VERB_TRACE=C:\kaya\flightrec\format_python-vtrace.txt
python C:\kaya\format.py > C:\kaya\out_format_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_format_python.txt
