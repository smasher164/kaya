...
rmdir /s /q C:\kaya\legs\window_csharp 2>nul
mkdir C:\kaya\legs\window_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\window_csharp\state
set KAYA_SELFTEST=window
set KAYA_VERB_TRACE=C:\kaya\flightrec\window_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_window_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_window_csharp.txt
