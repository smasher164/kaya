...
rmdir /s /q C:\kaya\legs\reorder_python 2>nul
mkdir C:\kaya\legs\reorder_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\reorder_python\state
set KAYA_SELFTEST=reorder
set KAYA_VERB_TRACE=C:\kaya\flightrec\reorder_python-vtrace.txt
