...
rmdir /s /q C:\kaya\legs\clipboard_go 2>nul
mkdir C:\kaya\legs\clipboard_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\clipboard_go\state
set KAYA_SELFTEST=clipboard
set KAYA_VERB_TRACE=C:\kaya\flightrec\clipboard_go-vtrace.txt
...
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_clipboard_go.txt
