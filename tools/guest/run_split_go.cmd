...
rmdir /s /q C:\kaya\legs\split_go 2>nul
mkdir C:\kaya\legs\split_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\split_go\state
set KAYA_SELFTEST=split
set KAYA_VERB_TRACE=C:\kaya\flightrec\split_go-vtrace.txt
...
go build -o C:\kaya\split_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_split_go.txt 2>&1
if errorlevel 1 goto done
split_go.exe >> C:\kaya\out_split_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_split_go.txt
