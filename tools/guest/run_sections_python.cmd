...
rmdir /s /q C:\kaya\legs\sections_python 2>nul
mkdir C:\kaya\legs\sections_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sections_python\state
set KAYA_SELFTEST=sections
set KAYA_VERB_TRACE=C:\kaya\flightrec\sections_python-vtrace.txt
