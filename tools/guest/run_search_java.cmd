...
rmdir /s /q C:\kaya\legs\search_java 2>nul
mkdir C:\kaya\legs\search_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\search_java\state
set KAYA_SELFTEST=search
set KAYA_VERB_TRACE=C:\kaya\flightrec\search_java-vtrace.txt
...
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_search_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_search_java.txt
