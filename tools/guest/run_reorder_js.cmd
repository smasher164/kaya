...
rmdir /s /q C:\kaya\legs\reorder_js 2>nul
mkdir C:\kaya\legs\reorder_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\reorder_js\state
set KAYA_SELFTEST=reorder
set KAYA_VERB_TRACE=C:\kaya\flightrec\reorder_js-vtrace.txt
node C:\kaya\reorder.ts > C:\kaya\out_reorder_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_reorder_js.txt
