...
rmdir /s /q C:\kaya\legs\radio_go 2>nul
mkdir C:\kaya\legs\radio_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\radio_go\state
set KAYA_SELFTEST=radio
set KAYA_VERB_TRACE=C:\kaya\flightrec\radio_go-vtrace.txt
...
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_radio_go.txt
