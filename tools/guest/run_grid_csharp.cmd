...
rmdir /s /q C:\kaya\legs\grid_csharp 2>nul
mkdir C:\kaya\legs\grid_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\grid_csharp\state
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_grid_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_grid_csharp.txt
