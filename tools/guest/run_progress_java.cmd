...
rmdir /s /q C:\kaya\legs\progress_java 2>nul
mkdir C:\kaya\legs\progress_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\progress_java\state
...
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_progress_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_progress_java.txt
