...
rmdir /s /q C:\kaya\legs\grow_js 2>nul
mkdir C:\kaya\legs\grow_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\grow_js\state
set KAYA_SELFTEST=grow
set KAYA_VERB_TRACE=C:\kaya\flightrec\grow_js-vtrace.txt
node C:\kaya\grow.ts > C:\kaya\out_grow_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_grow_js.txt
