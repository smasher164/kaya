...
rmdir /s /q C:\kaya\legs\tasksbig_rust 2>nul
mkdir C:\kaya\legs\tasksbig_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\tasksbig_rust\state
set KAYA_SELFTEST=tasksbig
set KAYA_VERB_TRACE=C:\kaya\flightrec\tasksbig_rust-vtrace.txt
tasks.exe > C:\kaya\out_tasksbig_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_tasksbig_rust.txt
