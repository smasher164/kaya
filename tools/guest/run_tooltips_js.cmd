...
rmdir /s /q C:\kaya\legs\tooltips_js 2>nul
mkdir C:\kaya\legs\tooltips_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\tooltips_js\state
set KAYA_SELFTEST=tooltips
set KAYA_VERB_TRACE=C:\kaya\flightrec\tooltips_js-vtrace.txt
