...
rmdir /s /q C:\kaya\legs\align_python 2>nul
mkdir C:\kaya\legs\align_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\align_python\state
set KAYA_SELFTEST=align
set KAYA_VERB_TRACE=C:\kaya\flightrec\align_python-vtrace.txt
