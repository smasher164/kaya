...
rmdir /s /q C:\kaya\legs\submit_csharp 2>nul
mkdir C:\kaya\legs\submit_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\submit_csharp\state
set KAYA_SELFTEST=submit
set KAYA_VERB_TRACE=C:\kaya\flightrec\submit_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_submit_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_submit_csharp.txt
