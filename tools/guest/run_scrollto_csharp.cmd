...
rmdir /s /q C:\kaya\legs\scrollto_csharp 2>nul
mkdir C:\kaya\legs\scrollto_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scrollto_csharp\state
set KAYA_SELFTEST=scrollto
set KAYA_VERB_TRACE=C:\kaya\flightrec\scrollto_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_scrollto_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scrollto_csharp.txt
