...
rmdir /s /q C:\kaya\legs\formatar_java 2>nul
mkdir C:\kaya\legs\formatar_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatar_java\state
set KAYA_LOCALE=ar-EG
set KAYA_SELFTEST=formatar
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatar_java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_formatar_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatar_java.txt
