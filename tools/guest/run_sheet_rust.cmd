...
rmdir /s /q C:\kaya\legs\sheet_rust 2>nul
mkdir C:\kaya\legs\sheet_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sheet_rust\state
set KAYA_SELFTEST=sheet
set KAYA_VERB_TRACE=C:\kaya\flightrec\sheet_rust-vtrace.txt
sheet.exe > C:\kaya\out_sheet_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sheet_rust.txt
