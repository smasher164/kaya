...
rmdir /s /q C:\kaya\legs\flexshrink_rust 2>nul
mkdir C:\kaya\legs\flexshrink_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\flexshrink_rust\state
set KAYA_SELFTEST=flexshrink
set KAYA_VERB_TRACE=C:\kaya\flightrec\flexshrink_rust-vtrace.txt
flexshrink.exe > C:\kaya\out_flexshrink_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_flexshrink_rust.txt
