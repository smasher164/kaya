...
rmdir /s /q C:\kaya\legs\submit_rust 2>nul
mkdir C:\kaya\legs\submit_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\submit_rust\state
set KAYA_SELFTEST=submit
set KAYA_VERB_TRACE=C:\kaya\flightrec\submit_rust-vtrace.txt
submit.exe > C:\kaya\out_submit_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_submit_rust.txt
