...
rmdir /s /q C:\kaya\legs\sections_go 2>nul
mkdir C:\kaya\legs\sections_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sections_go\state
set KAYA_SELFTEST=sections
set KAYA_VERB_TRACE=C:\kaya\flightrec\sections_go-vtrace.txt
...
go build -o C:\kaya\sections_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_sections_go.txt 2>&1
if errorlevel 1 goto done
sections_go.exe >> C:\kaya\out_sections_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sections_go.txt
