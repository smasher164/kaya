...
rmdir /s /q C:\kaya\legs\adaptive_go 2>nul
mkdir C:\kaya\legs\adaptive_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\adaptive_go\state
set KAYA_SELFTEST=adaptive
set KAYA_VERB_TRACE=C:\kaya\flightrec\adaptive_go-vtrace.txt
...
go build -o C:\kaya\adaptive_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_adaptive_go.txt 2>&1
if errorlevel 1 goto done
adaptive_go.exe >> C:\kaya\out_adaptive_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_adaptive_go.txt
