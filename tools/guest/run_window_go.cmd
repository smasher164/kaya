...
rmdir /s /q C:\kaya\legs\window_go 2>nul
mkdir C:\kaya\legs\window_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\window_go\state
set KAYA_SELFTEST=window
set KAYA_VERB_TRACE=C:\kaya\flightrec\window_go-vtrace.txt
...
go build -o C:\kaya\window_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_window_go.txt 2>&1
if errorlevel 1 goto done
window_go.exe >> C:\kaya\out_window_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_window_go.txt
