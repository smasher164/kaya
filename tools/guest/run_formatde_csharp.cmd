...
rmdir /s /q C:\kaya\legs\formatde_csharp 2>nul
mkdir C:\kaya\legs\formatde_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatde_csharp\state
set KAYA_LOCALE=de-DE
set KAYA_SELFTEST=formatde
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatde_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_formatde_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatde_csharp.txt
