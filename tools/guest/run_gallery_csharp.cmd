...
rmdir /s /q C:\kaya\legs\gallery_csharp 2>nul
mkdir C:\kaya\legs\gallery_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\gallery_csharp\state
set KAYA_SELFTEST=gallery
set KAYA_VERB_TRACE=C:\kaya\flightrec\gallery_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_gallery_csharp.txt 2>&1
