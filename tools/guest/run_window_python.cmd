...
rmdir /s /q C:\kaya\legs\window_python 2>nul
mkdir C:\kaya\legs\window_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\window_python\state
set KAYA_SELFTEST=window
set KAYA_VERB_TRACE=C:\kaya\flightrec\window_python-vtrace.txt
