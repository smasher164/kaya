...
rmdir /s /q C:\kaya\legs\search_go 2>nul
mkdir C:\kaya\legs\search_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\search_go\state
set KAYA_SELFTEST=search
set KAYA_VERB_TRACE=C:\kaya\flightrec\search_go-vtrace.txt
...
go build -o C:\kaya\search_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_search_go.txt 2>&1
if errorlevel 1 goto done
search_go.exe >> C:\kaya\out_search_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_search_go.txt
