...
rmdir /s /q C:\kaya\legs\formatar_js 2>nul
mkdir C:\kaya\legs\formatar_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatar_js\state
set KAYA_LOCALE=ar-EG
set KAYA_SELFTEST=formatar
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatar_js-vtrace.txt
node C:\kaya\format.ts > C:\kaya\out_formatar_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatar_js.txt
