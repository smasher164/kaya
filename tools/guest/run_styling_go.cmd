...
rmdir /s /q C:\kaya\legs\styling_go 2>nul
mkdir C:\kaya\legs\styling_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\styling_go\state
set KAYA_SELFTEST=styling
set KAYA_VERB_TRACE=C:\kaya\flightrec\styling_go-vtrace.txt
...
go build -o C:\kaya\styling_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_styling_go.txt 2>&1
if errorlevel 1 goto done
styling_go.exe >> C:\kaya\out_styling_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_styling_go.txt
