...
rmdir /s /q C:\kaya\legs\progress_python 2>nul
mkdir C:\kaya\legs\progress_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\progress_python\state
set KAYA_SELFTEST=progress
set KAYA_VERB_TRACE=C:\kaya\flightrec\progress_python-vtrace.txt
...
python C:\kaya\progress.py > C:\kaya\out_progress_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_progress_python.txt
