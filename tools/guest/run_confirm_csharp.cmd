...
rmdir /s /q C:\kaya\legs\confirm_csharp 2>nul
mkdir C:\kaya\legs\confirm_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\confirm_csharp\state
set KAYA_SELFTEST=confirm
set KAYA_VERB_TRACE=C:\kaya\flightrec\confirm_csharp-vtrace.txt
...
C:\kaya\cs\bin\Debug\net10.0\kaya-guests.exe > C:\kaya\out_confirm_csharp.txt 2>&1
