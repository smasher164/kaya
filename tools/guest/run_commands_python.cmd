...
rmdir /s /q C:\kaya\legs\commands_python 2>nul
mkdir C:\kaya\legs\commands_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\commands_python\state
set KAYA_SELFTEST=commands
set KAYA_VERB_TRACE=C:\kaya\flightrec\commands_python-vtrace.txt
...
python C:\kaya\commands.py > C:\kaya\out_commands_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_commands_python.txt
