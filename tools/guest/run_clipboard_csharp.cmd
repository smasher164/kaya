...
rmdir /s /q C:\kaya\legs\clipboard_csharp 2>nul
mkdir C:\kaya\legs\clipboard_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\clipboard_csharp\state
set KAYA_SELFTEST=clipboard
set KAYA_VERB_TRACE=C:\kaya\flightrec\clipboard_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_clipboard_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_clipboard_csharp.txt
