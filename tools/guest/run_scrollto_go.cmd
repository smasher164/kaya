...
rmdir /s /q C:\kaya\legs\scrollto_go 2>nul
mkdir C:\kaya\legs\scrollto_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\scrollto_go\state
set KAYA_SELFTEST=scrollto
set KAYA_VERB_TRACE=C:\kaya\flightrec\scrollto_go-vtrace.txt
...
go build -o C:\kaya\scrollto_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_scrollto_go.txt 2>&1
if errorlevel 1 goto done
scrollto_go.exe >> C:\kaya\out_scrollto_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_scrollto_go.txt
