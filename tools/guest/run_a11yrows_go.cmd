...
rmdir /s /q C:\kaya\legs\a11yrows_go 2>nul
mkdir C:\kaya\legs\a11yrows_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\a11yrows_go\state
...
a11yrows_go.exe >> C:\kaya\out_a11yrows_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_a11yrows_go.txt
