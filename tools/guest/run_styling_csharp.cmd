...
rmdir /s /q C:\kaya\legs\styling_csharp 2>nul
mkdir C:\kaya\legs\styling_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\styling_csharp\state
set KAYA_SELFTEST=styling
set KAYA_VERB_TRACE=C:\kaya\flightrec\styling_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_styling_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_styling_csharp.txt
