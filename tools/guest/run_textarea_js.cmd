...
rmdir /s /q C:\kaya\legs\textarea_js 2>nul
mkdir C:\kaya\legs\textarea_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\textarea_js\state
set KAYA_SELFTEST=textarea
set KAYA_VERB_TRACE=C:\kaya\flightrec\textarea_js-vtrace.txt
