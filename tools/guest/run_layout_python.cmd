...
rmdir /s /q C:\kaya\legs\layout_python 2>nul
mkdir C:\kaya\legs\layout_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\layout_python\state
set KAYA_SELFTEST=layout
set KAYA_VERB_TRACE=C:\kaya\flightrec\layout_python-vtrace.txt
