...
rmdir /s /q C:\kaya\legs\select_java 2>nul
mkdir C:\kaya\legs\select_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\select_java\state
set KAYA_SELFTEST=select
set KAYA_VERB_TRACE=C:\kaya\flightrec\select_java-vtrace.txt
...
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_select_java.txt 2>&1
