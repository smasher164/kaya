...
rmdir /s /q C:\kaya\legs\grid_python 2>nul
mkdir C:\kaya\legs\grid_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\grid_python\state
set KAYA_SELFTEST=grid
set KAYA_VERB_TRACE=C:\kaya\flightrec\grid_python-vtrace.txt
...
python C:\kaya\grid.py > C:\kaya\out_grid_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_grid_python.txt
