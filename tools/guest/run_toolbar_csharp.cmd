...
rmdir /s /q C:\kaya\legs\toolbar_csharp 2>nul
mkdir C:\kaya\legs\toolbar_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\toolbar_csharp\state
set KAYA_SELFTEST=toolbar
set KAYA_VERB_TRACE=C:\kaya\flightrec\toolbar_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_toolbar_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_toolbar_csharp.txt
