...
rmdir /s /q C:\kaya\legs\clipboard_python 2>nul
mkdir C:\kaya\legs\clipboard_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\clipboard_python\state
set KAYA_SELFTEST=clipboard
set KAYA_VERB_TRACE=C:\kaya\flightrec\clipboard_python-vtrace.txt
...
python C:\kaya\clipboard.py > C:\kaya\out_clipboard_python.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_clipboard_python.txt
