...
rmdir /s /q C:\kaya\legs\formatde_js 2>nul
mkdir C:\kaya\legs\formatde_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\formatde_js\state
set KAYA_LOCALE=de-DE
set KAYA_SELFTEST=formatde
set KAYA_VERB_TRACE=C:\kaya\flightrec\formatde_js-vtrace.txt
node C:\kaya\format.ts > C:\kaya\out_formatde_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_formatde_js.txt
