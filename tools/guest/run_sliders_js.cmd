...
rmdir /s /q C:\kaya\legs\sliders_js 2>nul
mkdir C:\kaya\legs\sliders_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\sliders_js\state
set KAYA_SELFTEST=sliders
set KAYA_VERB_TRACE=C:\kaya\flightrec\sliders_js-vtrace.txt
node C:\kaya\sliders.ts > C:\kaya\out_sliders_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_sliders_js.txt
