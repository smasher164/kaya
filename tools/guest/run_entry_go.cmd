...
rmdir /s /q C:\kaya\legs\entry_go 2>nul
mkdir C:\kaya\legs\entry_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\entry_go\state
set KAYA_SELFTEST=entry
set KAYA_VERB_TRACE=C:\kaya\flightrec\entry_go-vtrace.txt
...
go build -o C:\kaya\entry_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_entry_go.txt 2>&1
if errorlevel 1 goto done
entry_go.exe >> C:\kaya\out_entry_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_entry_go.txt
