...
rmdir /s /q C:\kaya\legs\select_go 2>nul
mkdir C:\kaya\legs\select_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\select_go\state
set KAYA_SELFTEST=select
set KAYA_VERB_TRACE=C:\kaya\flightrec\select_go-vtrace.txt
...
go build -o C:\kaya\select_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_select_go.txt 2>&1
