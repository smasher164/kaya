...
rmdir /s /q C:\kaya\legs\textarea_go 2>nul
mkdir C:\kaya\legs\textarea_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\textarea_go\state
set KAYA_SELFTEST=textarea
set KAYA_VERB_TRACE=C:\kaya\flightrec\textarea_go-vtrace.txt
...
go build -o C:\kaya\textarea_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_textarea_go.txt 2>&1
