...
rmdir /s /q C:\kaya\legs\panels_java 2>nul
mkdir C:\kaya\legs\panels_java\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\panels_java\state
set KAYA_SELFTEST=panels
set KAYA_VERB_TRACE=C:\kaya\flightrec\panels_java-vtrace.txt
java -cp C:\kaya\java\classes dev.kaya.guests.Main > C:\kaya\out_panels_java.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_panels_java.txt
