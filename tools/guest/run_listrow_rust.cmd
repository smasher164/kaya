...
rmdir /s /q C:\kaya\legs\listrow_rust 2>nul
mkdir C:\kaya\legs\listrow_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listrow_rust\state
set KAYA_SELFTEST=listrow
set KAYA_VERB_TRACE=C:\kaya\flightrec\listrow_rust-vtrace.txt
listrow.exe > C:\kaya\out_listrow_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_listrow_rust.txt
