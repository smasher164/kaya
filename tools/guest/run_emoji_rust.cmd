...
rmdir /s /q C:\kaya\legs\emoji_rust 2>nul
mkdir C:\kaya\legs\emoji_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\emoji_rust\state
set KAYA_SELFTEST=emoji
set KAYA_VERB_TRACE=C:\kaya\flightrec\emoji_rust-vtrace.txt
emoji.exe > C:\kaya\out_emoji_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_emoji_rust.txt
