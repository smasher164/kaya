...
rmdir /s /q C:\kaya\legs\listdetail_python 2>nul
mkdir C:\kaya\legs\listdetail_python\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\listdetail_python\state
set KAYA_SELFTEST=listdetail
set KAYA_VERB_TRACE=C:\kaya\flightrec\listdetail_python-vtrace.txt
