...
rmdir /s /q C:\kaya\legs\badge_rust 2>nul
mkdir C:\kaya\legs\badge_rust\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\badge_rust\state
set KAYA_SELFTEST=badge
set KAYA_VERB_TRACE=C:\kaya\flightrec\badge_rust-vtrace.txt
badge.exe > C:\kaya\out_badge_rust.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_badge_rust.txt
