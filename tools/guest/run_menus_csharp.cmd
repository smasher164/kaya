...
rmdir /s /q C:\kaya\legs\menus_csharp 2>nul
mkdir C:\kaya\legs\menus_csharp\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\menus_csharp\state
set KAYA_SELFTEST=menus
set KAYA_VERB_TRACE=C:\kaya\flightrec\menus_csharp-vtrace.txt
...
C:\kaya\cs-out\kaya-guests.exe > C:\kaya\out_menus_csharp.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_menus_csharp.txt
