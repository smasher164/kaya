...
rmdir /s /q C:\kaya\legs\radio_js 2>nul
mkdir C:\kaya\legs\radio_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\radio_js\state
set KAYA_SELFTEST=radio
set KAYA_VERB_TRACE=C:\kaya\flightrec\radio_js-vtrace.txt
node C:\kaya\radio.ts > C:\kaya\out_radio_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_radio_js.txt
