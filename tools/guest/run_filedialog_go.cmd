...
rmdir /s /q C:\kaya\legs\filedialog_go 2>nul
mkdir C:\kaya\legs\filedialog_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\filedialog_go\state
set KAYA_SELFTEST=filedialog
set KAYA_VERB_TRACE=C:\kaya\flightrec\filedialog_go-vtrace.txt
...
go build -o C:\kaya\filedialog_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_filedialog_go.txt 2>&1
if errorlevel 1 goto done
filedialog_go.exe >> C:\kaya\out_filedialog_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_filedialog_go.txt
