...
rmdir /s /q C:\kaya\legs\tooltips_go 2>nul
mkdir C:\kaya\legs\tooltips_go\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\tooltips_go\state
set KAYA_SELFTEST=tooltips
set KAYA_VERB_TRACE=C:\kaya\flightrec\tooltips_go-vtrace.txt
...
go build -o C:\kaya\tooltips_go.exe dev.kaya/guests/go/cmd > C:\kaya\out_tooltips_go.txt 2>&1
if errorlevel 1 goto done
tooltips_go.exe >> C:\kaya\out_tooltips_go.txt 2>&1
:done
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_tooltips_go.txt
