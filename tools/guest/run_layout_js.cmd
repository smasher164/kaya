...
rmdir /s /q C:\kaya\legs\layout_js 2>nul
mkdir C:\kaya\legs\layout_js\state 2>nul
set XDG_STATE_HOME=C:\kaya\legs\layout_js\state
set KAYA_SELFTEST=layout
set KAYA_VERB_TRACE=C:\kaya\flightrec\layout_js-vtrace.txt
node C:\kaya\layout.ts > C:\kaya\out_layout_js.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\kaya\out_layout_js.txt
