...
final class UndoTodoKaya {
    ...
    /** The record template: `for (var row : UndoTodoKaya.rows(tx, c))`
    ...
    static KayaApp.Rows<KayaApp.Widget, Row> rows(
            KayaApp.Tx tx, KayaRecords.Collection<Long, Undo.UndoTodo> c) {
    ...
    static KayaApp.Rows<KayaApp.Node, Row> rows(
            KayaApp.RowSurface row, KayaRecords.Collection<Long, Undo.UndoTodo> c) {
