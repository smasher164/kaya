...
func (r todoRow) Spacer() kaya.Node { return r.t.Spacer() }

func (r todoRow) Entry(onChange func(*kaya.Tx, int64, string)) kaya.Node {
...
func (r todoRow) SetHelp(n kaya.Node, text string) { r.t.SetHelp(n, text) }

func (r todoRow) Help(n kaya.Node, f kaya.Field[string]) { r.c.Help(r.t, n, f) }

func (r todoRow) SetPlaceholder(n kaya.Node, text string) { r.t.SetPlaceholder(n, text) }

func (r todoRow) Placeholder(n kaya.Node, f kaya.Field[string]) { r.c.Placeholder(r.t, n, f) }

func (r todoRow) SetHref(n kaya.Node, url string) { r.t.SetHref(n, url) }

func (r todoRow) Href(n kaya.Node, f kaya.Field[string]) { r.c.Href(r.t, n, f) }

func (r todoRow) SetAccepts(n kaya.Node, kinds ...string) { r.t.SetAccepts(n, kinds...) }

func (r todoRow) SetFill(n kaya.Node, on bool)          { r.t.SetFill(n, on) }
func (r todoRow) SetAlign(n kaya.Node, mode kaya.Align) { r.t.SetAlign(n, mode) }
func (r todoRow) SetFilled(n kaya.Node, tint kaya.Tint) { r.t.SetFilled(n, tint) }

func (r todoRow) SetColumnsAuto(n kaya.Node, minWidth float64) { r.t.SetColumnsAuto(n, minWidth) }

func (r todoRow) SetWrap(n kaya.Node, on bool) { r.t.SetWrap(n, on) }
