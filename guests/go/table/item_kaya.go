...
func (r itemRow) Spacer() kaya.Node { return r.t.Spacer() }
...
func (r itemRow) SetHelp(n kaya.Node, text string) { r.t.SetHelp(n, text) }

func (r itemRow) Help(n kaya.Node, f kaya.Field[string]) { r.c.Help(r.t, n, f) }

func (r itemRow) SetPlaceholder(n kaya.Node, text string) { r.t.SetPlaceholder(n, text) }
...
func (r itemRow) SetRole(n kaya.Node, role kaya.Role) { r.t.SetRole(n, role) }
