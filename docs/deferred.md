...
## POLISH — the GTK sections sidebar is the narrowest of the five (the maintainer, from the S4 review captures, 2026-09-09)
...
## POLISH — GTK draws some button labels and the header title bold and wide, unlike the Plex Sans the lane installs (the maintainer, from the S4 review captures, 2026-09-09)
