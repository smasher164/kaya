...
## BUILD — task manager S3: local notifications (rulings TAKEN 2026-09-08; SHIPPED 891ad047 the same day, matrix ALL PASS 1,745 legs on five lanes)
...
## BUILD — S9: the closed-app click on every platform (rulings TAKEN 2026-09-08; built the same day and night on five agents, every lane green through both acts — mac 438, iOS 42 of the rust suite, linux 761, android 141, windows 275; the plain matrix on the frozen tree is the line below)
